...
CREATE TABLE `packagedetails` (
  ...
  `pNumberOfPackages` int DEFAULT NULL,
  `pDimensions` varchar(255) DEFAULT NULL,
  `pFromAddress` varchar(255) DEFAULT NULL,
  `pToAddress` varchar(255) DEFAULT NULL,
  `pFromZip` int DEFAULT NULL,
  `pToZip` int DEFAULT NULL,
  `pFromCity` varchar(255) DEFAULT NULL,
  `pToCity` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`pId`),
  UNIQUE KEY `pId` (`pId`)
