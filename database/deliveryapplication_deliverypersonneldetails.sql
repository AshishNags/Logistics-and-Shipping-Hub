...
--
-- Table structure for table `deliverypersonneldetails`
--

DROP TABLE IF EXISTS `deliverypersonneldetails`;
...
--
-- Dumping data for table `deliverypersonneldetails`
--

LOCK TABLES `deliverypersonneldetails` WRITE;
/*!40000 ALTER TABLE `deliverypersonneldetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `deliverypersonneldetails` ENABLE KEYS */;
UNLOCK TABLES;
