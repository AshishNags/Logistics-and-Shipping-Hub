...
CREATE TABLE `shippingdetails` (
  ...
  `shPackageShipped` tinyint(1) DEFAULT NULL,
  `shRescheduleTime` datetime DEFAULT NULL,
  UNIQUE KEY `shId` (`shId`),
  KEY `pId` (`pId`),
  CONSTRAINT `shippingdetails_ibfk_1` FOREIGN KEY (`pId`) REFERENCES `packagedetails` (`pId`)
