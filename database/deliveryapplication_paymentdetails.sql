...
CREATE TABLE `paymentdetails` (
  ...
  `pCardNumber` int DEFAULT NULL,
  `pCvv` smallint DEFAULT NULL,
  `pExpiry` date DEFAULT NULL,
  UNIQUE KEY `paymentDetailsId` (`paymentDetailsId`),
  KEY `uId` (`uId`),
  CONSTRAINT `paymentdetails_ibfk_1` FOREIGN KEY (`uId`) REFERENCES `userdetails` (`uId`)
